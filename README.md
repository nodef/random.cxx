...
Developed by [Illia](https://github.com/ilqvya).

- [Random for modern C++ with convenient API](#random-for-modern-c-with-convenient-api)
  ...
  - [Five-minute tutorial](#five-minute-tutorial)
    ...
    - [Bool](#bool)
    - [Random value from std::initializer\_list](#random-value-from-stdinitializer_list)
...
And then include `random.hpp` as follows:
```cxx
#include "node_modules/random.cxx/include/effolkronium/random.hpp"
```
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/random.cxx)
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/ilqvya/random)
